...
def create_app(test_config=None):
    ...
    def predict():
        ...
        if request.method == 'POST':
            ...
            return render_template('loan_approval.html', prediction_text=result)
            
            #if prediction[0]==1:
                #return render_template('loan_approval.html', prediction_text= 'Approved')
                
            #else:
                #return render_template('loan_approval.html', prediction_text= 'Declined')
